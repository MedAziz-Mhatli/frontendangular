...
export class AdvanceTableComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute,public MatieresS: MatieresService,public FichiersS: FichierMatiereService,public ChappitresS: ChapitresService, private router:Router,private http:HttpClient) { 
