  ...
  onEditSaveProduit(form: FormGroup): void {
    ...
    if (form.valid) {
     ...
     // const idVendeur = form.get('idVendeur')?.value;
      if (idProduit !== null  && nomProduit !== '' && prixActuel && prixRreduction && quantite && idCategorie) {
        const updatedProduit: Produit = {
         ...
         // imageProduit: imageProduit,
          ...
          categorie: { idCategorie: idCategorie.idCategorie, nomCategorie: categorie.nomCategorie }
          // idVendeur: idVendeur
        };
