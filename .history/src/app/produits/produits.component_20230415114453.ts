        ...
        const produit: Produit = {
          ...
          //  imageProduit: this.registerForm.value.imageProduit,
           ...
           idCategorie:this.registerForm.value.idCategorie,
            categorie:{idCategorie:this.registerForm.value.idCategorie,nomCategorie:this.registerForm.value.nomCategorie,nomCategorie:this.registerForm.value.nomCategorie},
      ...
      if (idProduit !== null  && nomProduit !== '' && prixActuel && prixRreduction && quantite && categorie) {
        const updatedProduit: Produit = {
         ...
         // imageProduit: imageProduit,
          ...
          idCategorie: 1,
          categorie: { idCategorie: 1, nomCategorie: "laitt" }
          // idVendeur: idVendeur
        };
