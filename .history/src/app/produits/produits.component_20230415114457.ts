        ...
        const produit: Produit = {
          ...
          //  imageProduit: this.registerForm.value.imageProduit,
           ...
           idCategorie:this.registerForm.value.idCategorie,
            categorie:{idCategorie:this.registerForm.value.idCategorie,nomCategorie:this.registerForm.value.nomCategorie,imageUrl:this.registerForm.value.nomCategorie},
