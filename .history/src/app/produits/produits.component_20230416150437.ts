 ...
 expanded: any = {};
        ...
        const produit: Produit = {
          ...
          //  imageProduit: this.registerForm.value.imageProduit,
           ...
           idCategorie:this.registerForm.value.idCategorie,
            categorie:{idCategorie:this.registerForm.value.idCategorie,nomCategorie:this.registerForm.value.nomCategorie,imageUrl:this.registerForm.value.imageUrl},
  ...
  onEditSaveProduit(form: FormGroup): void {
     ...
     // const imageProduit = form.get('imageProduit')?.value;
      ...
      const catname = form.get('selectedCategory')?.value; 
      alert(this.currentcategory  +"--")
     // const idVendeur = form.get('idVendeur')?.value;
      if (idProduit !== null  && nomProduit !== '' && prixActuel && prixRreduction && quantite ) {
        const updatedProduit: Produit = {
         ...
         // imageProduit: imageProduit,
          ...
          idCategorie: 1,
          categorie: { idCategorie: 1, nomCategorie: "laitt",imageUrl:null }
          // idVendeur: idVendeur
        };
       // updatedProduit.idCategorie = categorie.idCategorie;
  ...
  editRoww(row: any, rowIndex: number, content: any) {
    this.currentCategorie =row.categorie.nomCategorie
    this.selectedCategory = this.currentCategorie;
...
this.editForm.patchValue({
 ...
 // imageProduit: this.selectedRowDataa?.imageProduit,
  ...
  idCategorie: this.selectedRowDataa?.categorie.idCategorie,
  categorie: this.selectedRowDataa?.categorie,
  categoriename: this.selectedRowDataa?.categorie.nomCategorie,
...
alert("*****"+this.editForm.get('categoriename')?.value+"*****")
/************ */
     this.editForm = this.fb.group({
     ...
     // imageProduit: [row.imageProduit, Validators.required],
      ...
      dateExpiration: [row.dateExpiration, Validators.required],
    //  idCategorie: [row.idCategorie, Validators.required],
    categorie: [row.categorie ? row.categorie.nomCategorie : null, Validators.required],
...
//filtre jdid
  ...
  onEditSave(form: FormGroup) {
    ...
    //    value.imageProduit = form.value.imageProduit;
        ...
        value.dateExpiration = form.value.dateExpiration;
