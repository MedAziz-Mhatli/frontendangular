...
export class CategorieService {
  ...
  updateCategorie(categorie: Categorie, file: File): Observable<Categorie> {
    const formData = new FormData();
    formData.append('file', file);
    formData.append('nomCategorie', categorie.nomCategorie);
    formData.append('idCategorie', categorie.idCategorie.toString());

    return this.http.put<Categorie>(`${this.baseUrl}/update-Categorie`, formData, this.httpOptions);
  }
