...
export class CoursComponent implements OnInit {
 ...
 expanded: any = {};
  ...
  deleteCategorie(idProduit: number) {
    this.categorieService.deleteCategorie(idProduit).subscribe(() => {
      this.categories = this.categories.filter(c => c.idCategorie !== idProduit);
    });
  }
