...
this.editForm.patchValue({
  ...
  onEditSaveProduit(form: FormGroup): void {
    if (form.valid) {
      ...
      if (idProduit !== null && imageProduit && nomProduit && prixActuel && prixReduction && quantite && idCategorie && idVendeur) {
        const updatedProduit: Produit = {
          ...
          quantite: quantite,
          idCategorie: number;idCategorieumber;
        };
        this.categorieService.updateCategorie(updatedProduit).subscribe(res => {
