...
export class CoursComponent implements OnInit {
  //jdid
  categories: any[]; produits: Produit[]=[];
  idCategorie: number = this.produits[0].idCategorie;
...
this.editForm.patchValue({
 ...
 // idVendeur: this.selectedRowDataa?.idVendeur,
  ...
  onSubmit() {
    ...
    let categorieSelectionnee: Categorie = this.categories.find(c => c.idCategorie == this.produits.idCategorie)!;
    // On ajoute la catégorie au produit
    this.produits.idCategorie = categorieSelectionnee.idCategorie;
