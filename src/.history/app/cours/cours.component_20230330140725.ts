    ...
    if (this.registerForm.valid) {
        const produit: Produit = {
         ...
         //   idCategorie:this.registerForm.value.idCategorie,
            categorie:{idCategorie:this.registerForm.value.idCategorie,nomCategorie:"lait"},
            
          //  idVendeur: this.registerForm.value.idVendeur,
        };
        alert(this.registerForm.value.idCategorie);
...
//filtre jdid
  ...
  onEditSave(form: FormGroup) {
    ...
    //    value.imageProduit = form.value.imageProduit;
        ...
        value.categorie = form.value.idCategorie;
