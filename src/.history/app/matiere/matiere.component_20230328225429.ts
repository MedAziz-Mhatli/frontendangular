...
this.editForm = this.fb.group({
  ...
  // set the form values with the selected categorie
  this.editForm.patchValue({
    idCategorie: this.selectedRowData.idCategorie,
    nomCategorie: this.selectedCategorie.nomCategorie,
  ...
  onUpdate() {
    if (this.editForm.valid) {
      const updatedCategorie: Categorie = {
        idCategorie: this.editForm.value.idCategorie,
        nomCategorie: this.editForm.value.nomCategorie,
      };
      this.categorieService.updateCategorie(updatedCategorie)
        .subscribe(
          res => {
            console.log('Categorie modifiée : ', res);
            // do something with the response
          },
          err => console.error(err)
        );
