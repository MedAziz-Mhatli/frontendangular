...
export class MatiereComponent implements OnInit {
  ...
  @Input() selectedCategorie: Categorie = { idCategorie: 0, nomCategorie: ''};;
  editForm: FormGroup; 
  rows = [];
  //
 ...
 expanded: any = {};
  ...
  deleteCategorie(): void {
    if (this.selectedCategorie != null) {
      this.categorieService.deleteCategorie(this.selectedCategorie.idCategorie)
        .subscribe(() => {
          this.categories = this.categories.filter(c => c !== this.selectedCategorie);
