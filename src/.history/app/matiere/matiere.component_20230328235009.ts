...
export class MatiereComponent implements OnInit {
 ...
 expanded: any = {};
  ...
  onSelectt(categorie: Categorie): void {
  ...
  deleteSelected(): void {
    Swal.fire({
      ...
      if (result.value && this.selectedCategorie) {
        this.categorieService.deleteCategorie(this.selectedCategorie.idCategorie).subscribe(() => {
          this.categories = this.categories.filter(c => c.idCategorie !== this.selectedCategorie.idCategorie);
