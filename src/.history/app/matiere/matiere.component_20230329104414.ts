...
this.editForm.patchValue({
  ...
  //suppression
  deleteEmployee(idCategorie: number) {
  ...
  Dans ce code, nous utilisons l'opérateur ?. pour vérifier si les propriétés idCategorie et nomCategorie de form sont nulles ou non définies. Si elles ne le sont pas, nous pouvons les utiliser pour créer l'objet updatedCategorie et appeler la méthode updateCategorie de notre service.
