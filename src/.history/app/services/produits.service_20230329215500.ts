...
export class ProduitsService {
  ...
  updateCategorie(produit: Produit): Observable<Produit> {
    return this.http.put<Produit>(`${this.baseUrl}/update-Produit`, produit);
  }

  deleteCategorie(id_produit: number): Observable<void> {
