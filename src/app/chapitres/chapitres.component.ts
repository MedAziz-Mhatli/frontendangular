...
@Component({
  ...
  styleUrls: ['./chapitres.component.sass'],
...
export class ChapitresComponent implements OnInit {
 ...
 expanded: any = {};
  ...
  fetch(cb) {
    ...
    req.open('GET', 'assets/data/chapitres.json');
    req.onload = () => {
  ...
  onEditSave(form: FormGroup) {
    this.data = this.data.filter((value, key) => {
      if (value.id == form.value.id) {
        ...
        value.Desc = form.value.Desc;
        value.Ens = form.value.Ens;
        value.trimestre = form.value.trimestre;
        value.Matiere = form.value.Matiere;
  ...
  addRecordSuccess() {
    this.toastr.success('chapitre ajoutée avec succès', '');
  }
  editRecordSuccess() {
    this.toastr.success('chapitre modifiée avec succès', '');
  }
  deleteRecordSuccess(count) {
    this.toastr.error(count + ' chapitre supprimée avec succès', '');
  }
